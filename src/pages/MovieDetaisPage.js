...
const MovieDetaisPage = () => {
  ...
  return (
    <div className="py-10">
      ...
      <p className="text-cecnter leading-relaxed max-w-[600px] mx-auto mb-10 ">
        {overview}
      </p>
  ...
  return (
    <div className="py-10">
      ...
      <div className="grid grid-cols-4 gap-5">
        {cast.slice(0, 4).map(
          (
            item // cast.slice(0,4) là sao chép mảng thành 4 người
          ) => (
          ...
          <div className="" key={item.id}>
            ...
            <div key={item.id} className="w-full aspect-video">
              <iframe
                ...
                title="VLOG #45: ĂN GÌ Ở TÂY BAN NHA? | duongfynn"
                frameBorder="0"
